...
def main():
    ...
    # Load CSS - inline for Databricks Apps compatibility
    def load_css():
        try:
            # Try to load external file first (for local development)
            css_path = os.path.join(os.path.dirname(__file__), 'styles.css')
            with open(css_path, 'r') as f:
                return f.read()
        except:
            # Fallback to inline CSS for Databricks Apps
            return """
    /* Global background */
    .stApp {
    ...
    /* Databricks Apps specific adjustments */
    .stApp > div {
        max-width: 100% !important;
    }
    ...
    /* Inactive tabs font size */
    .stTabs [data-baseweb="tab"] [data-testid="stMarkdownContainer"] p {
        font-size: 28px !important;
    }
    
    /* Active tab font size */
    ...
    /* Part Lookup JSON display font size */
    .stJson > div {
